...
public class RankedKNeigbourhoodNegativeVaccinated extends Plan {
    private final List<List<Integer>> centralities;
    private final Simulation sim;

    public RankedKNeigbourhoodNegativeVaccinated(Simulation sim, int k, Map<String, List<List<Integer>>> centralities, Lock centralityLock) {
